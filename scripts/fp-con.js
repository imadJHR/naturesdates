...
(async () => {
  ...
  const res = await p.goto("http://localhost:3000/contact-us", { waitUntil:"networkidle0", timeout:60000 });
  console.log("STATUS:", res.status());
  await new Promise(r=>setTimeout(r,1200));
  await p.screenshot({ path:"verify-shots/con-FP.png", fullPage:true });
  console.log("FP DONE");
  await b.close();
